...
use master;
ALTER DATABASE MIRRORDB   
    SET PARTNER = 'TCP://DESKTOP-LSM7R1H:5022'  
GO  
...
ALTER DATABASE MIRRORDB   
    SET PARTNER = 'TCP://DESKTOP-LSM7R1H:5023'  
GO  
...
ALTER DATABASE MIRRORDB   
    SET WITNESS = 'TCP://DESKTOP-LSM7R1H:5024'  
GO 

-- important command to grant acces
grant connect on endpoint :: Endpt_Mir to [NT AUTHORITY\SYSTEM]
